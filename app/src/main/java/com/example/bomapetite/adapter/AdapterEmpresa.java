...
import com.example.bomapetite.activity.HomeActivity;
...
public class AdapterEmpresa extends RecyclerView.Adapter<AdapterEmpresa.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int i) {
        ...
        holder.tempo.setText("Media de " + empresa.getTempo() + " Min  | ");
        holder.entrega.setText("Taxa R$ " + empresa.getPrecoEntrega().toString());
